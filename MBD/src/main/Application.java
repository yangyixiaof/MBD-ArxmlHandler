...
//			}
////			else {
////				System.out.println("interface type:" + intf.getClass());
////			}
//		}
//	}
//	
...
//						SRPort p = new SRPort(s_name, is_input);// sc, 
//						sc.AddPort(p);
...
//							
//							SRPort p_s = ArUtil.GetPortFromCompoInstRef(am, p_prov, c_prov);
//							SRPort p_t = ArUtil.GetPortFromCompoInstRef(am, p_req, c_req);
//							
...
//							SRPort pp = am.GetPort(port_full_name);
